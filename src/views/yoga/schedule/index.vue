<template>
	...
	<el-card>
		<el-space>
			...
			<el-space>
				<el-button plain icon="Download" @click="downloadHandle('/yoga/schedule/export')">导出</el-button>
			</el-space>
			<el-space>
		...
		<el-table v-loading="state.dataListLoading" :data="state.dataList" border class="layout-table" show-overflow-tooltip @selection-change="selectionChangeHandle" >
			...
			<el-table-column prop="teacherId" label="老师ID" header-align="center" align="center"></el-table-column>
			<el-table-column prop="spaceId" label="场地ID" header-align="center" align="center"></el-table-column>
			...
			<el-table-column prop="maxSeats" label="最大名额" header-align="center" align="center"></el-table-column>
			<el-table-column prop="bookedSeats" label="已预约数" header-align="center" align="center"></el-table-column>
			<el-table-column prop="status" label="1-可预约 2-已满 3-取消" header-align="center" align="center"></el-table-column>
...
<script setup lang="ts" name="YogaScheduleIndex">
	...
	dataListUrl: '/yoga/schedule/page',
	deleteUrl: '/yoga/schedule',
	queryForm: {
