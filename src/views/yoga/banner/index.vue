<template>
	...
	<el-card>
		...
		<el-table v-loading="state.dataListLoading" :data="state.dataList" border class="layout-table" show-overflow-tooltip @selection-change="selectionChangeHandle" >
			...
			<el-table-column prop="title" label="图片标题" header-align="center" align="center"></el-table-column>
			<el-table-column prop="imageUrl" label="图片URL" header-align="center" align="center"></el-table-column>
			<el-table-column prop="sort" label="排序值（越大越靠前）" header-align="center" align="center"></el-table-column>
			<el-table-column prop="status" label="状态 0:停用 1:启用" header-align="center" align="center"></el-table-column>
			<el-table-column prop="clickLink" label="点击跳转链接" header-align="center" align="center"></el-table-column>
...
<script setup lang="ts" name="YogaBannerIndex">
	...
	dataListUrl: '/yoga/banner/page',
	deleteUrl: '/yoga/banner',
	queryForm: {
