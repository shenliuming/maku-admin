<template>
	...
	<el-card>
		<el-space>
			...
			<el-space>
				<el-button plain icon="Download" @click="downloadHandle('/yoga/teacher/export')">导出</el-button>
			</el-space>
			<el-space>
		...
		<el-table v-loading="state.dataListLoading" :data="state.dataList" border class="layout-table" show-overflow-tooltip @selection-change="selectionChangeHandle" >
			...
			<el-table-column prop="memberId" label="关联会员ID" header-align="center" align="center"></el-table-column>
			<el-table-column prop="status" label="状态 0:离职 1:在职" header-align="center" align="center"></el-table-column>
...
<script setup lang="ts" name="YogaTeacherIndex">
	...
	dataListUrl: '/yoga/teacher/page',
	deleteUrl: '/yoga/teacher',
	queryForm: {
