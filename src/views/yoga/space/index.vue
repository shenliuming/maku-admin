<template>
	...
	<el-card>
		<el-space>
			...
			<el-space>
				<el-button plain icon="Download" @click="downloadHandle('/yoga/space/export')">导出</el-button>
			</el-space>
			<el-space>
		...
		<el-table v-loading="state.dataListLoading" :data="state.dataList" border class="layout-table" show-overflow-tooltip @selection-change="selectionChangeHandle" >
			...
			<el-table-column prop="capacity" label="容纳人数" header-align="center" align="center"></el-table-column>
			<el-table-column prop="status" label="状态 0:关闭 1:开放" header-align="center" align="center"></el-table-column>
...
<script setup lang="ts" name="YogaSpaceIndex">
	...
	dataListUrl: '/yoga/space/page',
	deleteUrl: '/yoga/space',
	queryForm: {
