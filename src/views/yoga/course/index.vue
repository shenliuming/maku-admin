<template>
	...
	<el-card>
		<el-space>
			...
			<el-space>
				<el-button plain icon="Download" @click="downloadHandle('/yoga/course/export')">导出</el-button>
			</el-space>
			<el-space>
		...
		<el-table v-loading="state.dataListLoading" :data="state.dataList" border class="layout-table" show-overflow-tooltip @selection-change="selectionChangeHandle" >
			...
			<el-table-column prop="type" label="1-私教 2-小班 3-团课 4-精品课" header-align="center" align="center"></el-table-column>
...
<script setup lang="ts" name="YogaCourseIndex">
	...
	dataListUrl: '/yoga/course/page',
	deleteUrl: '/yoga/course',
	queryForm: {
