<template>
	...
	<el-card>
		<el-space>
			...
			<el-space>
				<el-button plain icon="Download" @click="downloadHandle('/yoga/booking/export')">导出</el-button>
			</el-space>
			<el-space>
		...
		<el-table v-loading="state.dataListLoading" :data="state.dataList" border class="layout-table" show-overflow-tooltip @selection-change="selectionChangeHandle" >
			...
			<el-table-column prop="scheduleId" label="排期ID" header-align="center" align="center"></el-table-column>
			<el-table-column prop="status" label="1-预约中 2-已完成 3-已取消" header-align="center" align="center"></el-table-column>
...
<script setup lang="ts" name="YogaBookingIndex">
	...
	dataListUrl: '/yoga/booking/page',
	deleteUrl: '/yoga/booking',
	queryForm: {
